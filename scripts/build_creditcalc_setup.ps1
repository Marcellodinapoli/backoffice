# Build CreditCalc Windows: Setup.exe (consigliato per il sito) + MSIX opzionale.
...
Write-Host ""
Write-Host "========================================"
Write-Host "  CARICA SU FIREBASE (Setup.exe):"
Write-Host "  $setup"
Write-Host "========================================"
Write-Host ""
Write-Host "BackOffice -> App Windows -> Carica installer -> Usa"
